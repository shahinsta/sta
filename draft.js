...
//set Qstr in href
        jQuery.each($('.special_offer a'), function (i, val) {
            ActionHref = $(this).attr('href');
            var NewActionHref = updateQueryStringParameter(ActionHref, 'ref_province', province_id);
            $(this).attr('href',NewActionHref);
        });
        if (province_id == '10' || province_id == '31') {
            $('.sale_pallet').show();
            $('#region-1').slideDown();
            region = "region-1";
        }
        else if (province_id == '12' || province_id == '14' || province_id == '15' || province_id == '2' || province_id == '16') {
            $('.sale_pallet').show();
            $('#region-2').slideDown();
            region = "region-2";
        }
        else if (province_id == '11' || province_id == '27') {
            $('.sale_pallet').show();
            $('#region-3').slideDown();
            region = "region-3";
            if(province_id == '27'){
        ...
        else if (province_id == '1' || province_id == '17' || province_id == '8' || province_id == '20' || province_id == '5' || province_id == '4' || province_id == '3' || province_id == '9' || province_id == '18' || province_id == '22' || province_id == '23' || province_id == '24' || province_id == '25' || province_id == '29' || province_id == '7' || province_id == '19' || province_id == '26' || province_id == '28' || province_id == '30') {
            $('.sale_pallet').show();
            $('#region-4').slideDown();
            region = "region-4";
        }
        else if (province_id == '21' || province_id == '13') {
            $('.sale_pallet').show();
            $('#region-5').slideDown();
            region = "region-5";
        }
